...
# -----------------------------------------
spi_setBitOrder = lib.bcm2835_spi_setBitOrder
spi_setBitOrder.argtypes = {_uint}

# void bcm2835_spi_setDataMode( uint8_t ):
# ----------------------------------------
spi_setDataMode = lib.bcm2835_spi_setDataMode
spi_setDataMode.argtypes = {_uint}

# void bcm2835_spi_setClockDivider( uint16_t );
# ---------------------------------------------
spi_setClockDivider = lib.bcm2835_spi_setClockDivider
spi_setClockDivider.argtypes = {_uint}
